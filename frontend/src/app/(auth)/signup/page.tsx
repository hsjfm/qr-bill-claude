...
export default function SignupPage() {
  ...
  return (
    <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
      <h1 className="mb-1 text-2xl font-bold text-zinc-900 dark:text-white">Create account</h1>
      <p className="mb-6 text-sm text-zinc-500">Get your API key instantly, no credit card needed.</p>
